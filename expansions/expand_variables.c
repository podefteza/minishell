...
/*   Updated: 2025/05/21 15:12:29 by carlos-j         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	handle_dollar_inside_quotes(char **input, char **ptr,
		t_shell *shell)
{
	char	*var_value;
...
static void	expand_dollar_quoted_block(char **input, char **ptr, t_shell *shell,
		int *in_single_quote)
{
	char	quote;
